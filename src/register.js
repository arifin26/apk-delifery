...
//   }
  ...
  render () {
    ...
    return (
      ...
      <ImageBackground source={require('../gambar/9b613327-ee16-4fd3-bf26-f84c109a3704.jpeg')} style={{height:'100%',width:'100%',backgroundColor: 'rgba(0,0,0,0.5)'}}>
      <View style={{ flex: 1 }}>
      ...
      <ScrollView>
        ...
        <View style={{justifyContent:'center',alignItems:'center',paddingTop:30}}>
          <Image source={require('../gambar/motor.png')} style={{height:140,width:140}}/>
        </View>
        ...
        <View style={Styles.ViewDisplay}>
          ...
          <TextInput
            style={Styles.TextInputDisplay3}
          ...
          <View style={{flex:1,paddingLeft:237,position:'absolute',paddingTop:342}}>
          <TouchableOpacity
          ...
          <View style={{paddingRight:20}}>
           <Image source={require('../gambar/next.png')} style={{height:80,width:80}}/>
